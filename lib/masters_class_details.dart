...
class MastersClassDetails extends StatefulWidget {
  const MastersClassDetails({Key? key}) : super(key: key);
  
  @override
  _MastersClassDetailsState createState() => _MastersClassDetailsState();
}

class _MastersClassDetailsState extends State<MastersClassDetails> {
  @override
