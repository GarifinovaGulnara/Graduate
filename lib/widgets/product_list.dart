                  ...
                  if(snapshot.data == null){
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if(!snapshot.hasData)
                      {
                        ...
                        return Card(
                        child: InkWell(
                          onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (context) => ProductDetails(id_prod: docs.id, name: docs['name'], des: docs['description'], price: docs['price'], img: docs['img'],))),
                          child: Column(
                            children: [
                              SizedBox(
